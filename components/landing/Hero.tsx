  ...
  return (
    ...
    >
      ...
      <div className="relative z-[2] grid grid-cols-1 lg:grid-cols-[1fr_400px] xl:grid-cols-[1fr_440px] gap-12 xl:gap-20 items-center max-w-[1400px] w-full">
        ...
        {/* ── Left ── */}
        <div>
          <div className="inline-flex items-center gap-3 font-mono text-[10px] tracking-[0.22em] uppercase text-mist mb-9">
            <span className="w-1.5 h-1.5 rounded-full bg-voltage-light" />
            Firma tecnológica estratégica — Medellín · Bogotá
          </div>

          <h1
            className="font-display font-semibold text-bone leading-[1.01] tracking-[-0.025em] max-w-[700px]"
          ...
          <p
            className="mt-8 text-fog/80 leading-[1.7] max-w-[460px]"
        ...
        <div className="hidden lg:block">
          <div
            className="border border-white/[0.08] p-7 xl:p-8"
            style={{
